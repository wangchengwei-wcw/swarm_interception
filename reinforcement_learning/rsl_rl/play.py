...
elif args_cli.task not in ["FAST-Quadcopter-Bodyrate", "FAST-Intercept-Single", "FAST-Intercept-Swarm", "FAST-Quadcopter-Vel", "FAST-Quadcopter-Waypoint", "FAST-Swarm-Bodyrate", "FAST-Swarm-Acc", "FAST-Swarm-Vel", "FAST-Swarm-Waypoint"]:
    raise ValueError(
